...
See [AI_USAGE_DOCUMENTATION.md](./AI_USAGE_DOCUMENTATION.md) for details on AI assistance used in this project.

### 📝 Complete Source Code
The complete source code with all Java files will be added to this repository. For now, you can find the project structure above.
...
### 📄 License
This project is created for the PeerIslands Backend Developer Assignment.

---

## 🔗 Repository Link
**GitHub Repository**: https://github.com/khatrivishal89/ecommerce-order-system
